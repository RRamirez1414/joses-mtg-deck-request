...
// api-dev/api-utils/deckRequestHtml.ts
var deckRequestHtml_exports = {};
__export(deckRequestHtml_exports, {
  generateDeckRequestHtml: () => generateDeckRequestHtml
});
module.exports = __toCommonJS(deckRequestHtml_exports);
var generateDeckRequestHtml = ({
  firstName,
  lastName,
  email,
  description,
