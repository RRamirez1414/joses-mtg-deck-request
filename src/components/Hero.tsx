      ...
      <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
        <div className="hidden sm:mb-8 sm:flex sm:justify-center">
          <div className="relative rounded-full px-3 py-1 text-sm/6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
            ...
            <a
              href="https://moxfield.com/users/Galapaghost"
              target="_blank"
        ...
        <div className="text-center">
          ...
          <p className="mt-8 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8">
            I specialize in creating personalized Magic the Gathering decks
            tailored to your unique playstyle and preferences. Let me help you
            bring your vision to life with a custom-built deck designed just for
            you.
          </p>
